...
const EspaceArtistiqueListTable = (props) => {
  ...
  const columns = [
      {
        title: i18n('entities.espaceArtistique.fields.artiste'),
        sorter: false,
        dataIndex: 'artiste',
        render: (value) => <ArtisteListItem value={value} />,
      },
      {
        title: i18n('entities.espaceArtistique.fields.supports'),
        sorter: false,
        dataIndex: 'supports',
      ...
      {
        title: i18n('entities.espaceArtistique.fields.description'),
        sorter: true,
      ...
      },
    {
      ...
      render: (_, record) => (
        <div className="table-actions">
          ...
          {hasPermissionToEdit && (
            <Link to={`/espace-artistique/${record.id}/edit`}>
              {i18n('common.edit')}
            </Link>
          )}
