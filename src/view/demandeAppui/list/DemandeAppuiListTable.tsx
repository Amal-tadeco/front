...
const DemandeAppuiListTable = (props) => {
  ...
  const columns = [
      ...
      {
        title: i18n('entities.demandeAppui.fields.gouvernorat'),
        sorter: true,
      ...
      {
        title: i18n('entities.demandeAppui.fields.importance'),
        sorter: true,
      ...
      {
        title: i18n('entities.demandeAppui.fields.description'),
        sorter: true,
