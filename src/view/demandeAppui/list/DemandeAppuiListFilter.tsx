...
const previewRenders = {
  type: {
    ...
    render: filterRenders.enumerator('entities.demandeAppui.enumerators.type',),
  },
  etat: {
    label: i18n('entities.demandeAppui.fields.etat'),
    render: filterRenders.enumerator('entities.demandeAppui.enumerators.etat',),
  },
  gouvernorat: {
    label: i18n('entities.demandeAppui.fields.gouvernorat'),
    render: filterRenders.enumerator('entities.demandeAppui.enumerators.gouvernorat',),
  },
  importance: {
    label: i18n('entities.demandeAppui.fields.importance'),
    render: filterRenders.enumerator('entities.demandeAppui.enumerators.importance',),
  },
  description: {
